        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(MainActivity2.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadFile();
                }
            }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            if (task.isSuccessful()) { Uri downloadUri = task.getResult();
                                Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),Float.parseFloat(mEditTextFilePrice.getText().toString().trim()), downloadUri.toString());
                                mDatabaseRef.push().setValue(upload);
                                Toast.makeText(MainActivity2.this, "Upload successful", Toast.LENGTH_LONG).show();
                            }
                            else { Toast.makeText(MainActivity2.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }
                    })
